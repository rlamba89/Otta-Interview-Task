...
**Answer**: 1791 and 5193 with similarity score of 181
...
**Answer**: 46 and 92 with similarity score of 104
...
**Answer**: https://www.axahealth.co.uk/, https://truecue.com/

**Task**: Tell us about the biggest challenge you faced in building the above.

**Answer**: TrueCue application was built on legacy framework AngularJs and the biggest challenege was to migrate the application to ReactJs while adding the business feature into the application.
